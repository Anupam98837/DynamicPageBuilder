...
(() => {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    function computePermissions(){
      ...
      const createDeleteRoles = ['admin','super_admin','director','principal','author'];
      const writeRoles = ['admin','super_admin','director','principal','hod','faculty','technical_assistant','it_person','author'];
